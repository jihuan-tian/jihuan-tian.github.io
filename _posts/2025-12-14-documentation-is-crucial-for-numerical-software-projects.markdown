...
This experience makes me realize that to make it possible for a software project keeping a long term sustainable development and maintenance, clear and well organized documentation is crucial. The documentation should contain enough tutorials and examples for users as well as explanation of technical details for library developers. And the developer documentation is more important than the user documentation.

Moreover, for a numerical software project, not only the data structure, work flow and architecture, the mathematical theories behind the algorithms should also be clearly and rigorously summarized, explained and illustrated.

For short, without the said user documentation, developer documentation and mathematical documentation, I don’t see any chance of a numerical software project&rsquo;s survival. Therefore, in the HierBEM project, I make continuous efforts in this aspect with

-   the user and mathematical documentations coalesced into [several examples](https://jihuan-tian.github.io/hierbem-site/examples/) and
-   the [developer documentation](https://jihuan-tian.github.io/hierbem-site/doxygen/index.html) generated from detailed source code comments with Doxygen.
