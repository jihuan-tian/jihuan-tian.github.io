---
layout: post
title: The "fact" function in Octave
date: 2022-04-23
categories: [computer]
tags: [Octave]
mathjax: false
...
The `fact` function in Octave displays an amazing and random fact about the world's greatest hacker, who is Richard Stallman. For example,

> Richard Stallman doesn't sleep; he is compiling.

After opening the definition of `fact`, we can see the verses are stored in the variable `wisdom`:
